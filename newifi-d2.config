...
CONFIG_DEFAULT_pdnsd-alt=y
CONFIG_DEFAULT_procd=y
CONFIG_DEFAULT_shadowsocks-libev=y
CONFIG_DEFAULT_simple-obfs=y
# CONFIG_DEFAULT_strongswan=y
CONFIG_DEFAULT_trojan=y
...
# CONFIG_DEFAULT_luci-app-sfe is not set
