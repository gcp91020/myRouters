...
[ -e ../2024-dnsmasq-22.03.patch ] && /bin/cp ../2024-dnsmasq-22.03.patch package/network/services/dnsmasq/patches/ && ls -l package/network/services/dnsmasq/patches/
# [ -e package/network/services/dnsmasq/src/rfc1035.c ] && cat package/network/services/dnsmasq/src/rfc1035.c
