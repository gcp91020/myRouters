...
# 
KMOD="https://downloads.openwrt.org/releases/23.05.5/targets/ramips/$MOD/kmods/"
...
[ -e ../2024-dnsmasq-2.90.patch ] && /bin/cp ../2024-dnsmasq-2.90.patch package/network/services/dnsmasq/patches/ && ls -l package/network/services/dnsmasq/patches/
